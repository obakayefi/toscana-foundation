...
import { LayoutDashboard, Image as ImageIcon, GraduationCap, LogOut, Menu, X, Globe } from 'lucide-react';
...
export default function AdminDashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-zinc-50 flex">
            ...
            {/* Sidebar */}
            <aside className={`
                fixed inset-y-0 left-0 z-50 w-64 bg-zinc-950 text-white transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:flex-shrink-0 flex flex-col
